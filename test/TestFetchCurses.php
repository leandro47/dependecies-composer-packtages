...
namespace Leandro47\FetchCursesAlura\Tests;
...
class TestFetchCurses extends TestCase
{
    ...
    {
        $crawler = new Crawler();
        $buscador = new FetchCurses($this->httpClientMock, $crawler);
        $cursos = $buscador->fetch($this->url);
